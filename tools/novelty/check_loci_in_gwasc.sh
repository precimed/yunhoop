...
# registed in gwascatalog with respect to specific phenotype, if so the
# loci is not regarded as novel loci.
...
if [ $# -lt 3 ]; then
  ...
  echo "           keyword - keyword such as name of part of the name of investigated trait"
