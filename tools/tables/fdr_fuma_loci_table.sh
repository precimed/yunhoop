...
if [ $# -ne 3 ] && [ $# -ne 5 ] && [ $# -ne 9 ]; then
  ...
  echo "           fdr_fuma_snp_table - file generated by script fdr_fuma_snp_table.sh, please make sure it is named as TRAIT1_vs_TRAIT2_snps.txt, so the tags for the traits can be parsed"
