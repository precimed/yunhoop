...
#-------------------------------------------------------------------------#
if [ $# -lt 4 ]; then
  echo "Usage:     sh fdr_fuma_input.sh fdr_clump_snp_file fdr r2 outfile"
  ...
  echo "Example:   sh fdr_fuma_input.sh conj.result.clump.snps.csv 0.1 0.6 trait1_vs_trait2_input_snps.txt"
  exit 0
fi
#-------------------------------------------------------------------------#
